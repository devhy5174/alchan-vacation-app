...
export default function DayDetailModal({ dateStr, plan, onClose }: Props) {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white rounded-t-2xl flex flex-col max-h-[70vh]">
        {/* 핸들 */}
        ...
        {/* 게이지 */}
        {tasks.length > 0 && (
          <div className="px-5 pt-3 pb-6 flex items-center gap-2 border-t border-gray-100">
